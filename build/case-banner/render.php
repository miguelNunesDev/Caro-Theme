...
<section id="case-banner" class="relative w-full h-[61.1rem] md:h-[69rem]" <?= get_block_wrapper_attributes(); ?>>
    ...
    <div class="flex flex-wrap items-center h-full mx-auto container-block">
        <header class="max-md:mx-auto <?= $card ?>" style="background: linear-gradient(74deg, rgba(34, 30, 30, 0.50) 21.29%, rgba(83, 81, 80, 0.50) 80.09%);box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);">
            ...
            <h2 class="font-raleway pt-[2.4rem] md:pt-[2.4rem] text-white font-bold text-[4.2rem] md:text-[6rem] leading-[1.2em] tracking-[-0.04em]"><?= get_post_meta(get_the_ID(), 'case_title', true) ?></h2>
